sap.ui.define([
	...
	return Opa5.extend("de.robertwitt.demo.epm.salesordercockpit.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["de/robertwitt/demo/epm/salesordercockpit/localService/mockserver"], function (mockserver) {
