...
sap.ui.define([
	...
	return BaseController.extend("de.robertwitt.demo.epm.salesordercockpit.controller.Worklist", {
		...
		onInit: function () {
			...
			this.addHistoryEntry({
				...
				intent: "#SalesOrderCockpit-display"
			}, true);
		},
		 ...
		 * @param {sap.ui.base.Event} oEvent the icon tab bar select event
		 * @public 
		 */
		onFilterTabBarSelect: function (oEvent) {
			var aFilters = [];
			var sLifecycleStatus = oEvent.getParameter("key");
			if (sLifecycleStatus !== this.constants.salesOrder.lifecycleStatus.none) {
				aFilters = [new Filter("LifecycleStatus", FilterOperator.EQ, sLifecycleStatus)];
			}
